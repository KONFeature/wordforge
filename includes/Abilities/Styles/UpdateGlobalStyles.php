...
class UpdateGlobalStyles extends AbstractAbility {
    ...
    public function get_description(): string {
        return __( 'Update global styles (theme.json) settings - colors, typography, spacing, etc.', 'wordforge' );
    }
    ...
    public function execute( array $args ): array {
        ...
        $current_config = json_decode( $current_post->post_content, true ) ?: [];
    ...
    private function get_or_create_global_styles_post(): ?int {
        ...
        $post_id = wp_insert_post( [
            ...
            'post_content' => wp_json_encode( [ 'version' => 3 ] ),
        ] );
