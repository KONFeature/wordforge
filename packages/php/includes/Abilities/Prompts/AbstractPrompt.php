...
abstract class AbstractPrompt {
	 ...
	 * @return array<string, mixed>
	 */
	protected function user_message( string $text, array $annotations = array() ): array {
		$content = array(
			'type' => 'text',
			'text' => $text,
		);
	 ...
	 * @return array<string, mixed>
	 */
	protected function assistant_message( string $text, array $annotations = array() ): array {
		$content = array(
			'type' => 'text',
			'text' => $text,
		);
